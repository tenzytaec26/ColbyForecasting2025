...
plot(greedy_input['class'], 
     ...
     pch = ".", 
     extent = mask, 
     main = "May, June, and July greedy class distribution",
     reset = FALSE)
...
plot(conservative_input['class'], 
     ...
     pch = ".", 
     extent = mask, 
     main = "May, June and July conservative class distribution",
     reset = FALSE)
plot(coast, col = "orange", add = TRUE)
```
...
make_model_input_by_month  = function(mon = "Aug",
                                      obs = read_observations("Cetorhinus maximus"),
                                      raster = NULL,
